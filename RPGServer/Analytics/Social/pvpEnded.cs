...
{
    public class PvpEnded
    {
        public string eventName = "pvpEnded";
        public string userID = "";
        public string sessionID = "";
        public string eventTimestamp = DateTime.Now.ToString();
        public EventParams_PvpEnded eventParams;
        public GoalCounts goalCounts = new GoalCounts();

        public PvpEnded(RewardType i_rewardType)
        {
            eventParams = new EventParams_PvpEnded(i_rewardType);
        }

        public PvpEnded(string i_userID, string i_sessionID, string i_eventTimestamp, RewardType i_rewardType)
        {
            userID = i_userID;
    ...
    public class EventParams_PvpEnded
    {
        public Reward reward;

        public EventParams_PvpEnded(RewardType i_rewardType)
        {
